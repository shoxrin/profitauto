...
class Monitor:
    ...
    def get_logger(self):
        ...
        c_format = logging.Formatter('[%(asctime)s][%(levelname)s]:%(message)s', datefmt='%DD.%MM-%H:%M:%S')
        f_format = logging.Formatter('[%(asctime)s][%(levelname)s]:%(message)s', datefmt='%DD.%MM-%H:%M:%S')
